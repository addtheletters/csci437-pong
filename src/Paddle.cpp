...
void Paddle::tick(float delta, ENTITY_MAP &others, sf::Vector2u window_size) {
...
sf::Vector2f Paddle::getSize() { return size_; }
...
Paddle::ContactStatus Paddle::closestCardinal(sf::Vector2f dir) {
  sf::Vector2f cardinals[] = {sf::Vector2f(0, 1), sf::Vector2f(1, 0),
