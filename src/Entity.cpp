...
void Entity::draw(sf::RenderWindow &window) { return; }
...
sf::Vector2f Entity::getPos() { return pos_; }

void Entity::setPos(sf::Vector2f pos) { pos_ = pos; }

void Entity::move(sf::Vector2f displacement) { pos_ = pos_ + displacement; }

sf::Vector2f Entity::getVel() { return vel_; }

void Entity::setVel(sf::Vector2f vel) { vel_ = vel; }
